...
class AppTheme extends DefaultTheme {
  ...
  @override
  TextStyle appBarHeading({Color? color, FontStyle? fontStyle}) =>
      primary(size: 18, fontWeight: FontWeight.w500, color: Colors.white, fontStyle: fontStyle);
  @override
  ...
  TextStyle button({Color? color, FontStyle? fontStyle}) =>
      primary(size: 14, fontWeight: FontWeight.w500, color: color, fontStyle: fontStyle);
  @override
  ...
  TextStyle bodySmall({Color? color, FontStyle? fontStyle}) =>
      primary(size: 15, fontWeight: FontWeight.w400, color: color, fontStyle: fontStyle);
  @override
